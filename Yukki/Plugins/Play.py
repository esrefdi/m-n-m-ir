    ...
    if audio:
        ...
        if len(message.command) < 2:
            ...
            await message.reply_photo(
                ...
                caption=(
                    "**İstifadə təlimatı:** /play [Musiqi adı, YouTube keçidi və ya Telegramdan səs] Əgər siz oxutma siyahısını istifadə etmək istəyirsinizsə, aşağıdakılardan birini seçin.."
                ),
                reply_markup=InlineKeyboardMarkup(buttons),
            )
            return
